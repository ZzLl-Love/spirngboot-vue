...
<!--       隐藏id类，标识每一行数据-->
      <el-table-column align="center" sortable prop="id" label="Id" :width="0">
      </el-table-column>
      <el-table-column align="center" sortable prop="companyName" label="公司" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="nickName" label="用户名" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userName" label="姓名" width="120">
      </el-table-column>
      ...
      <el-table-column align="center" sortable prop="mail" label="邮件" min-width="120">
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
        ...
        <el-form-item label="邮件" prop="mail">
          <el-input size="small" v-model="editForm.mail" placeholder="请输入邮箱地址"></el-input>
        </el-form-item>
    ...
    submitForm(editData) {
      this.$refs[editData].validate(valid => {
        if (valid) {
          ...
          this.editForm.sex =this.editForm.sex === "男" ? 1: 0
